...
public class MyDialogUtils {
     ...
     */
    public static void CommDialog(final Context context, String title, String titleMsg, String cancleStr, View.OnClickListener cancleClickListener, String sureStr, View.OnClickListener sureClickListener) {
        if (commDialog != null) {//防止重复创建，确保只有一个对象
            commDialog.dismiss();
            commDialog = null;
        }
